...
# Load dataset
# Ensure this file is in your Replit project
file_path = './Dataset/articles recommendation dataset.csv'
...
joblib.dump(tfidf, './Pickle/content_based_model.pkl')
joblib.dump(cosine_sim, './Pickle/cosine_similarity_matrix.pkl')