...
# Load the dataset  # Update to your actual file path
try:
    file_path = './Dataset/fashion_products.csv'
...
recommended_products.to_csv('./Recommendations/recommended_products.csv', index=False)
print("Recommended products saved to /Recommendations/recommended_products.csv")